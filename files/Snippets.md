[
    ...
    {trigger: "sum", replacement: "\\sum_{${0:i} = $1}^{${2:n}} $3", options: "mA"},
    {trigger: "prod", replacement: "\\prod_{ $0 }^{ $1 }", options: "mA"},
    ...
    {trigger: "lra", replacement: "\\Leftrightarrow \\quad $0", options: "mA"},
